...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CEDIS.Core.Pgsql.Domain.User", b =>
                {
                    ...
                    b.Property<int?>("TwoFactorAutenticationId")
                        .HasColumnName("twofactorautenticationid")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("TwoFactorAutenticationId")
                        .HasName("ix_users_twofactorautenticationid");
            ...
            modelBuilder.Entity("Picking.Core.Domain.TwoFactorAuthenticator", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("id")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_twofactorauthenticator");

                    b.ToTable("twofactorauthenticator");
                });
            ...
            modelBuilder.Entity("CEDIS.Core.Pgsql.Domain.User", b =>
                {
                    b.HasOne("Picking.Core.Domain.TwoFactorAuthenticator", "TwoFactorAuthenticator")
                        .WithMany()
                        .HasForeignKey("TwoFactorAutenticationId")
                        .HasConstraintName("fk_users_twofactorauthenticator_twofactorautenticationid");
                });
